...
Desktop apps, machine learning tools, and electronics projects for everyday use.
...
- ⌚ [4-Digit School Clock](https://github.com/C0m3b4ck/4DigitArduinoSchoolClock) - a clock that shows the next lesson name and time on a 4-digit 7-segment display
- ⚡ [Arduino Experiments](https://github.com/C0m3b4ck/C0m3b4cks-Arduino-Experiments) - learning Arduino through hands-on scripts
- 🖱️ [Arduino Leonardo Mouse](https://github.com/C0m3b4ck/Arduino-Leonardo-Mouse) - firmware for an Arduino Leonardo with a Funduino Joystick Shield acting as a mouse
- 🪛 [KiCAD Models](https://github.com/C0m3b4ck/C0m3b4ck-KiCAD) - 3D models for KiCAD
- 🐁 [XM102K Mouse PCB](https://github.com/C0m3b4ck/XM102K-Mouse/) - reverse-engineered KiCAD remake of the XM102K PCB
- 🐁 [XM110K Mouse PCB](https://github.com/C0m3b4ck/XM110K-Mouse/) - reverse-engineered KiCAD remake of the XM110K PCB
- 🐁 [DazzerBlue Mouse PCB](https://github.com/C0m3b4ck/DazzerBlue-Mouse/) - reverse-engineered KiCAD remake of the DazzerBlue TRAMYS44940 PCB
...
Pinokio 1-click installs for each TTS backend:
...
- 🎙️ [Speech Demo](https://github.com/C0m3b4ck/VB6_TTS_STT) - both TTS and STT in Visual Basic 6 using Microsoft Speech API
...
- 🧪 [Chemquiz](https://github.com/C0m3b4ck/Chemquiz) - a chemistry quiz, in Polish
- 🧳 [Racoon MC Modpack Installer](https://github.com/C0m3b4ck/Racoon-MC-Modpack-Installer) - a downloader for Minecraft modpacks
- 🔡 [Digraphy](https://github.com/C0m3b4ck/Digraphy) - converts digraphs between languages
- 🙂 [Random Name Generator](https://github.com/C0m3b4ck/Random-Name-Generator) - generates random people's names
- 🎮 [Whisk Keyboard-To-Controller Linux](https://github.com/C0m3b4ck/Whisk-Keyboard-To-Controller-Linux) - converts keyboard and mouse presses into controller mappings
- ⌨️ [Keydash](https://github.com/C0m3b4ck/Keydash) - an offline version of TypeRacer
- 🧼 [Pagewipe ePub DRM Remover](https://github.com/C0m3b4ck/Pagewipe-ePub-DRM-Remover) - clean DRM metadata from ePub files
- 🤓 [Python Autocorrect](https://github.com/C0m3b4ck/PythonAutocorrect) - a simple autocorrect in Python
...
These projects are no longer maintained but remain available.

- 📔 ~~[BookwormPascal](https://github.com/C0m3b4ck/BookwormPascal)~~ - a rewrite of BookwormVB in Lazarus FreePascal
- 📚 ~~[Bookworm](https://github.com/C0m3b4ck/Bookworm)~~ - a program for book categorization, precompiled for Windows
- 🎮 ~~[Keydash-Cheats](https://github.com/C0m3b4ck/Keydash-Cheats)~~ - cheats for Keydash, used to test the anticheat
- 🖩 ~~[Numworm](https://github.com/C0m3b4ck/Numworm)~~ - a calculator in VB6
- 👁️ ~~[VBLearn](https://github.com/C0m3b4ck/VBLearn)~~ - a program to learn Visual Basic
- 🏧 ~~[MartATM](https://github.com/C0m3b4ck/MartATM)~~ - a legacy-compatible ATM project in Visual Basic
